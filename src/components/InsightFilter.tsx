...
export function InsightFilter({ activeFilter, onFilterChange, counts }: InsightFilterProps) {
  ...
  return (
    <div className="flex gap-2 p-1 bg-zinc-900/50 backdrop-blur-xl rounded-2xl border border-zinc-800/50 w-fit">
      {filters.map((filter) => {
